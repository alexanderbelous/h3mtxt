...
namespace Medea_NS
{
  ...
  void JsonArrayWriter<h3m::ReservedData<NumBytes>>::operator()(ScopedArrayWriter<std::byte>& elements_writer,
  ...
  template<std::size_t NumBytes>
  void JsonArrayWriter<h3m::BitSet<NumBytes>>::operator()(ScopedArrayWriter<std::uint8_t>& elements_writer,
