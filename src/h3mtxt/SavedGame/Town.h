...
namespace h3svg
{
  ...
  struct Town
  {
    ...
    // unknown4[61]:
    //   bit 0 seems to indicate if the Mana Vortex has NOT been used this week
    //   bits [1; 3] indicate the amount of the resource generated by Mystic Pond
    //   bits [4; 6] indicate the type of the resource generated by Mystic Pond (h3m::ResourceType)
    std::array<std::uint8_t, 62> unknown4 {};
