...
namespace h3m
{
  ...
  enum class HeroPortrait : std::uint8_t
  {
    ...
    GENERAL_KENDAL, /* 0x9C */
    CHRISTIAN2,     /* 0x9D */ // As he appears in the "Foolhardy Waywardness" campaign.
    ORDWALD,        /* 0x9E */
    FINNEAS,        /* 0x9F */
    GEM2,           /* 0xA0 */ // As she appears in the "Shadow of Death" campaigns.
    SANDRO2,        /* 0xA1 */ // As he appears in the campaigns before he turned into a lich.
    YOG2,           /* 0xA2 */ // As he appears in the "Birth of a Barbarian" campaign.
